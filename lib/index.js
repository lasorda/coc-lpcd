...
function doUpdateFileSymbol(document) {
  if (document.uri.endsWith(".c")) {
    generateFileSymbol(getFileRelativePath(document.uri));
  }
}
async function activate(context) {
  ...
  context.subscriptions.push(cocNvim.languages.registerCompletionItemProvider("coc-lpcd", "LPC", "lpc", {provideCompletionItems}, ["/", ">", "<"]), cocNvim.languages.registerDefinitionProvider(selector, {provideDefinition}), cocNvim.languages.registerDocumentSymbolProvider(selector, {provideDocumentSymbols}), cocNvim.languages.registerHoverProvider(selector, {provideHover}), cocNvim.workspace.onDidSaveTextDocument(doUpdateFileSymbol));
}
