...
function generateFileSymbol(filename) {
  let fileSymbol = {defined: [], include: [], variable: [], func: [], childFileSymbol: {}, lineno: 0, comment: []};
  if (filename in fileSymbolCacheTime && Date.now() / 1e3 - fileSymbolCacheTime[filename] < 1) {
